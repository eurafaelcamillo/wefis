...
class CadastrarDica extends React.Component {
    constructor(props) {
        super(props);
    ...
    onFormSubmit = async () => {
        ...
        this.props.onCreateDica(this.state.form, this.cb, this.props.navigation);
    };
...
const mapDispatchToProps = dispatch => ({
    onCreateDica: (form, cb, navigation) => dispatch(actions.createDica(form, cb, navigation)),
    checkToken: (navigation) => dispatch(actions.checkToken(navigation))
});

export default connect(mapStateToProps, mapDispatchToProps)(CadastrarDica);
