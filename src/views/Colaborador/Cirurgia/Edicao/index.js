...
class EditarCirurgia extends React.Component {
    constructor() {
        super();
    ...
    onFormSubmit = async () => {
        ...
        this.props.onEditCirurgia(this.state.form, this.cb, this.props.navigation);
    };
...
const mapStateToProps = state => ({
    editando: state.cirurgias.editando
});

const mapDispatchToProps = dispatch => ({
    onEditCirurgia: (form, cb, navigation) => dispatch(actions.editCirurgia(form, cb, navigation)),
    checkToken: (navigation) => dispatch(actions.checkToken(navigation))
});

export default connect(mapStateToProps, mapDispatchToProps)(EditarCirurgia);
