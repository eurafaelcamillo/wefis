...
class EditarTratamento extends React.Component {
    constructor() {
        super();
    ...
    componentDidMount() {
        ...
        const { _id, nome, descricao, data, status} = this.props.editando;
    ...
    onFormSubmit = async () => {
        ...
        this.props.onEditTratamento(this.state.form, this.cb, this.props.navigation);
    };
...
const mapStateToProps = state => ({
    editando: state.tratamentos.editando
});

const mapDispatchToProps = dispatch => ({
    onEditTratamento: (form, cb, navigation) => dispatch(actions.editTratamento(form, cb, navigation)),
    checkToken: (navigation) => dispatch(actions.checkToken(navigation))
});

export default connect(mapStateToProps, mapDispatchToProps)(EditarTratamento);
