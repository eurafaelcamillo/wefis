...
class VisualizarTratamento extends React.Component {
    constructor() {
        super();
    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <Header navigation={this.props.navigation} rota="Tratamentos" />
...
const mapStateToProps = state => ({
    visualizando: state.tratamentos.visualizando
});
...
export default connect(mapStateToProps, mapDispatchToProps)(VisualizarTratamento);
