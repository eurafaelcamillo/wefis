...
class VisualizarDepoimento extends React.Component {
    constructor() {
        super();
...
const mapStateToProps = state => ({
    visualizando: state.depoimentos.visualizando
});
...
export default connect(mapStateToProps, mapDispatchToProps)(VisualizarDepoimento);
